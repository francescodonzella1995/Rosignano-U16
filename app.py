...
- **Inserisci Dati**: registra un nuovo allenamento o una nuova partita
- **Storico Allenamenti**: sedute svolte, modifica, PDF e statistiche
- **Storico Partite**: storico partite, distinte ed eventi
