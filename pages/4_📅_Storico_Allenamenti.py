"""
Storico Allenamenti: elenco delle sedute svolte, modifica, PDF ed statistiche.
"""
...
st.set_page_config(page_title="Storico Allenamenti", page_icon="📅", layout="wide")
ensure_db_ready()
